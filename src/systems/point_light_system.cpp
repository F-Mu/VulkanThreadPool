...
namespace crp {
    ...
    PointLightSystem::PointLightSystem(CrpDevice &device, VkRenderPass renderPass,
    ...
    void PointLightSystem::createPipeline(VkRenderPass renderPass) {
        ...
        CrpPipeline::enableAlphaBlending(pipelineConfig);
    ...
    void PointLightSystem::render(FrameInfo &frameInfo) {
        std::map<float, CrpGameObject::id_t> sorted;
        for (auto &kv: frameInfo.gameObjects) {
            auto &obj = kv.second;
            if (obj.pointLight == nullptr)continue;
