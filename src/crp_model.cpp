...
namespace crp {
    ...
    CrpModel::CrpModel(CrpDevice &device, const CrpModel::Builder &builder) : crpDevice{device} {
    ...
    std::unique_ptr<CrpModel> CrpModel::createModelFromFile(
            CrpDevice &device, const std::string &filepath) {
        Builder builder{};
        builder.loadModel(ENGINE_DIR + filepath);
//        builder.loadModel(filepath);

        return std::make_unique<CrpModel>(device, builder);
    }
    ...
    void CrpModel::Builder::loadModel(const std::string &filepath) {
